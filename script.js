...
(function() {
    if (!window.VK || !VK.Widgets || !VK.Widgets.Post || !VK.Widgets.Post('vk_post_-42386223_176', -42386223, 176, 'zAQDZxKU73w4pespAiRwXCtboSA')) setTimeout(arguments.callee, 50);
}());
(function() {
    if (!window.VK || !VK.Widgets || !VK.Widgets.Post || !VK.Widgets.Post('vk_post_-42386223_177', -42386223, 177, 'o_WML6dtcAOXth18mmWA7L6ywFM')) setTimeout(arguments.callee, 50);
}());
(function() {
    if (!window.VK || !VK.Widgets || !VK.Widgets.Post || !VK.Widgets.Post('vk_post_-42386223_178', -42386223, 178, '6zfqd3TUxdN_Sb_m_sJBm0-F7D8')) setTimeout(arguments.callee, 50);
}());
(function() {
