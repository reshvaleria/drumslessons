...
mail("reshvaleria@gmail.com", "Заявка с сайта", "ФИО:".$fio.". E-mail: ".$email.". Номер телефона: ".$phone ,"From: info@drumslessons.ru \r\n");
if (mail("reshvaleria@gmail.com", "Заказ с сайта", "ФИО:".$fio.". E-mail: ".$email.". Номер телефона: ".$phone ,"From: info@drumslessons.ru \r\n"))
{
